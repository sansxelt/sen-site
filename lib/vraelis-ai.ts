...
export async function continueLeadConversation(input: {
  ...
  const system = [
    ...
    qualifyingBlock,
    "When the lead asks what's included, what they get, or about program/offer details, ANSWER by summarizing the business description and the services/prices you were given above — that's exactly what they're for. Don't deflect a basic details question you can already answer. Only invent nothing: stick to what's provided, don't promise specific outcomes, results, guarantees, timelines, or inclusions that aren't stated. If a genuinely specific detail isn't in what you were given, summarize what you do know and offer to have the owner confirm the rest.",
    ...
    OFFPLATFORM_RULE,
    paymentBlock,
    "Don't overpromise. Escalate to needs_owner ONLY when the lead asks for something the business clearly doesn't cover, a custom/bespoke request, a sensitive medical/legal/financial matter, or a highly specific detail you genuinely weren't given — NOT for routine 'what's included / how does it work / what do I get' questions you can answer from the info above. When you do escalate, don't ask qualifying questions about the thing you can't confirm or imply the business might provide it; say the owner will confirm and set status needs_owner.",
