...
- Account is unified: a vraelis.com sign-in is the same identity on the desktop. Sign-in on the desktop opens the browser to /desktop-auth, the user approves, and a session token comes back via the Vraelis:// URL scheme.
