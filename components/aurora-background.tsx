 ...
 * The opaque site header (bg-neutral-950) naturally hides whatever
 * aurora falls under it, so the blobs render across the full viewport
 * and the visible portion below the nav shows up smoothly.
 */
