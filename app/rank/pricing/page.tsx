        ...
        <div className="wrap">
          ...
          <div className="card" style={{ marginTop: 22, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20, flexWrap: "wrap", background: "var(--bg-2)", borderRadius: "var(--r-xl)" }}>
            <div style={{ maxWidth: 520 }}>
              ...
              <p style={{ fontSize: 14, color: "var(--fg-3)", margin: 0, lineHeight: 1.55 }}>Buy custom top-ups from $5 to $999,999. Every $1 adds 10 credits, and they never expire. Larger volumes for Scale &amp; enterprise are available by invoice.</p>
            </div>
