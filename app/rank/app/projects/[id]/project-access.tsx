  ...
  return (
    <div style={{ marginTop: 34 }}>
      ...
      <div className="card">
        ...
        <p style={{ fontSize: 11.5, color: "var(--fg-5)", margin: "8px 0 0" }}>Email delivery is not connected yet. Invitees will gain access after signing in with the invited email.</p>
