...
export default async function ConnectAppPage() {
  await requirePreflightOwner("/applications/new");

  return (
    <div className="wrap" style={{ maxWidth: 1240, paddingTop: "clamp(24px, 3vw, 40px)", paddingBottom: 80 }}>
      <Link href="/applications" style={{ display: "flex", width: "fit-content", alignItems: "center", gap: 7, fontSize: 13.5, color: "var(--fg-3)", textDecoration: "none", marginBottom: 18 }}>← Your apps</Link>
      <ConnectWorkspace />
    </div>
  );
}
