        ...
        <div className="card" style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          ...
          {v1Plan ? (
            <p style={{ fontSize: 12.5, color: "var(--fg-4)", marginTop: 6, marginBottom: 0, lineHeight: 1.5 }}>
              {v1Plan.passesPerMonth} Production Passes per month, up to {v1Plan.flowsPerPass} flows per pass{v1Plan.maxApplications === null ? "" : `, ${v1Plan.maxApplications} connected applications`}.
            </p>
          ) : null}
        </div>
        <div className="card" style={{ display: "flex", flexDirection: "column", gap: 4 }}>
