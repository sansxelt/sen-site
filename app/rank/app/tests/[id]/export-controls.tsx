...
export function ExportControls({ testId }: { testId: string }) {
  ...
  return (
    <div className="card" style={{ marginBottom: 26 }}>
      ...
      <p style={{ fontSize: 13.5, color: "var(--fg-3)", marginBottom: 14 }}>Export valid preference data, vote breakdowns, comments, and the report analysis — for internal review, dashboards, or model/product workflows. No private account data is included.</p>
