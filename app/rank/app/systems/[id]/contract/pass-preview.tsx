    ...
    <div style={box}>
      ...
      {data.readiness && data.readiness.requiresAuth ? (
        <div style={{ marginTop: 12, borderTop: "1px solid var(--line-1)", paddingTop: 10 }}>
          ...
          {!data.readiness.ok ? (
            <Link href={`/systems/${appId}/settings/connections`} style={{ display: "inline-block", marginTop: 8, fontSize: 12.5, fontWeight: 600, color: "var(--acc-deep)", textDecoration: "none" }}>
