    ...
    <>
      ...
      <section className="section" style={{ background: "var(--bg-2)" }}>
        <div className="wrap">
          ...
          <div className="tile-grid cols-2">
            {[
              ["You're using an LLM to check LLM output. Isn't that circular?", "The instant check is an AI assessment, and we say so plainly. What keeps it honest is calibration: you can route the same output to real people, and we track how often the check's pick matches theirs. The AI gives you speed on every ship; human judgment keeps it grounded. We never claim the check is a guarantee, and the scores are built to track what people think, not to replace them."],
