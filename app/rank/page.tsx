        ...
        <div className="wrap">
          ...
          <div className="tile-grid cols-2">
            {[
              ...
              ["Can this plug into my pipeline?", "Yes: POST your output to /api/v1/check and get structured scores, the recommended version, and line-level flags back in one call. Wire it into CI to catch problems before they ship, or into your app. Checks return signed webhooks and JSON / CSV exports."],
