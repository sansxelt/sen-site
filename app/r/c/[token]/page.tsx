...
// Public shared-report viewer for the retired AI-output-checker product ("AI output check", per-criterion scores, the version to ship). The current Vraelis product does not share
