...
const errorMessages: Record<string, string> = {
  ...
  CallbackRouteError: "The provider returned to sansxel, but the sign-in could not be completed.",
...
export const metadata: Metadata = {
  title: "Auth Error",
  description: "Review and recover from an authentication error in the sansxel sign-in flow.",
};
