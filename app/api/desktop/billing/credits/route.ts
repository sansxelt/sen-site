...
// v0.1.9 — buy credits.
// Accepts { amount_dollars: number } in [1, 500], creates a Stripe
// PaymentIntent for that amount in cents, and returns the client secret
// so the desktop billing panel can confirm via Stripe Elements.
//
