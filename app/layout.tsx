...
const vraelisMetadata: Metadata = {
  ...
  description:
    "Automated QA for the output your AI app ships. Get an instant check with per-criterion scores, the version to ship, and the exact lines to fix. Calibrated on real human judgment.",
    ...
    return (
      ...
      >
        <body className="min-h-full" style={{ background: "#FAF8F4" }}>
          ...
          <link rel="stylesheet" href="/vraelis/styles.css?v=23" />
          {children}
        </body>
      </html>
    );
