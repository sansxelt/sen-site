...
const vraelisMetadata: Metadata = {
  ...
  description:
    "AI built the product. Vraelis finishes the engineering. Connect your AI-built app and Vraelis runs it like production, in a real browser, then returns a launch decision with the exact blockers to fix.",
  ...
  openGraph: {
    ...
    description: "AI built the product. Vraelis finishes the engineering. A real browser runs your app like production and returns a launch decision with the evidence behind it.",
    ...
    return (
      ...
      >
        <body className="min-h-full" style={{ background: "#FAF8F4" }}>
          ...
          <link rel="stylesheet" href="/vraelis/tokens.css?v=19" />
          <link rel="stylesheet" href="/vraelis/styles.css?v=24" />
          {children}
        </body>
      </html>
    );
