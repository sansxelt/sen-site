        ...
        >
          ...
          <div className="mt-3 flex items-center gap-2 text-sm font-medium text-neutral-200">
            ...
            {copied === email ? (
              ...
              <span className="rounded-md border border-white/10 bg-white/5 px-1.5 py-0.5 text-[10px] text-neutral-500 transition group-hover:border-white/20 group-hover:text-neutral-300">
                Copy
              </span>
            )}
          </div>
